...
namespace Haven.Infrastructure.Migrations
{
    ...
    [Migration("20260824012414_AddSidecarDomainSupportAndTraefikDashboardAuth")]
    partial class AddSidecarDomainSupportAndTraefikDashboardAuth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Haven.Domain.Aggregates.Environment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Haven.Domain.Entities.DomainCertificate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid>("ServiceRegistryDomainId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ServiceRegistryDomainId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Haven.Domain.Entities.ServiceRegistryDomain", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Haven.Domain.Aggregates.Network", b =>
                {
                    b.HasOne("Haven.Domain.Aggregates.Environment", "Environment")
                        .WithMany()
            ...
            modelBuilder.Entity("Haven.Domain.Entities.DomainCertificate", b =>
                {
                    b.HasOne("Haven.Domain.Entities.ServiceRegistryDomain", "ServiceRegistryDomain")
                        .WithOne("Certificate")
                        .HasForeignKey("Haven.Domain.Entities.DomainCertificate", "ServiceRegistryDomainId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ServiceRegistryDomain");
                });
            ...
            modelBuilder.Entity("Haven.Domain.Entities.ServiceRegistryDomain", b =>
                {
                    b.HasOne("Haven.Domain.Aggregates.ServiceRegistryEntry", "ServiceRegistryEntry")
                        .WithMany("Domains")
