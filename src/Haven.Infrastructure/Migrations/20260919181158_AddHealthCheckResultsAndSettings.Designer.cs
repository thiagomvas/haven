...
namespace Haven.Infrastructure.Migrations
{
    ...
    [Migration("20260919181158_AddHealthCheckResultsAndSettings")]
    partial class AddHealthCheckResultsAndSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Haven.Domain.Entities.HealthCheck", b =>
                {
                    ...
                    b.Property<string>("LastRunReason")
                        .IsRequired()
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("Haven.Domain.Entities.HealthCheckResult", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("HealthCheckId", "RanAt")
            ...
            modelBuilder.Entity("Haven.Domain.Entities.HealthCheckResult", b =>
                {
                    b.HasOne("Haven.Domain.Entities.HealthCheck", null)
                        .WithMany()
