...
export function CreateProjectPage() {
  ...
  useSetBreadcrumbs([{ label: 'Projects', to: '/dashboard' }, { label: 'Create' }]);
    ...
    try {
      ...
      setError(
        err instanceof Error
          ? err.message
          : t('createPage.failedToCreate', 'Failed to create project')
      );
      setStatus('error');
    } finally {
      setIsLoading(false);
          ...
          <Card className={styles.successCard}>
            <CardHeader>
              ...
              <p className={styles.cardDescription}>
                {t('createPage.successDescription', 'Your project is ready to use')}
              </p>
            </CardHeader>
          ...
          <>
            ...
            <Card>
              <CardHeader>
                ...
                <p className={styles.cardDescription}>
                  {t(
                    'createPage.projectDetailsDescription',
                ...
                <div className={styles.formSection}>
                  <FormGroup>
                    ...
                    <FormInput
                      ...
                      type="text"
                      placeholder={t(
                        'createPage.projectNamePlaceholder',
                        'e.g., my-app, api-service'
                      )}
                      value={name}
                  ...
                  <FormGroup>
                    <FormLabel htmlFor="projectAlias">
                      ...
                      >
                        — used in Docker names, e.g. <code>haven-myapp-...</code> (2–8 chars)
                      </span>
                    </FormLabel>
                    <FormInput
                      id="projectAlias"
              ...
              <CardHeader>
                ...
                <p className={styles.cardDescription}>
                  {t(
                    ...
                    'Set project-scoped environment variables available to all services'
                  )}
                </p>
              </CardHeader>
