...
[Category("Unit")]
public sealed class BulkStopServicesValidatorTests
{
    private BulkStopServicesValidator _sut;

    [SetUp]
    public void Setup() => _sut = new BulkStopServicesValidator();
    ...
    private static BulkStopServicesCommand CreateCommand() => new()
    {
