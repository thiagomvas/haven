...
[Category("Unit")]
public sealed class BulkDeployServicesValidatorTests
{
    private BulkDeployServicesValidator _sut;

    [SetUp]
    public void Setup() => _sut = new BulkDeployServicesValidator();
    ...
    private static BulkDeployServicesCommand CreateCommand() => new()
    {
